  ...
  var m_helper = {
    ...
    insertAfter: function(a, b) {
      ...
      b.nextElementSibling
        ? c.insertBefore(a, b.nextElementSibling)
        : c.appendChild(a);
    },
    hide: function(a) {
...
function Multiselect(a) {
  if (
    ("undefined" != typeof $ && !$(a).is("select")) ||
    ("undefined" == typeof $ && "SELECT" != a.tagName)
  )
    throw "Multiselect: passed object must be a select";
  if (
    ("undefined" != typeof $ && !$(a).attr("multiple")) ||
    ("undefined" == typeof $ && !a.hasAttribute("multiple"))
  )
...
(Multiselect.prototype = {
  ...
  _createWrapper: function() {
    ...
    return (
      (a.className = "multiselect-wrapper"), (a.id = this._getIdentifier()), a
    );
  },
  ...
  _createItemList: function() {
    ...
    return (
      d.appendChild(c),
      d.appendChild(m_helper.create({ tag: "hr" })),
      d.appendChild(a),
      d
    );
  },
  _createItem: function(a, b, c) {
    var f = m_helper.checkbox({
      ...
      g = m_helper.create({ tag: "span", class: "multiselect-text" }),
      h = m_helper.create({ tag: a }),
      j = m_helper.label();
    return (
      (g.className = "multiselect-text"),
      (g.innerHTML = c),
      j.appendChild(f),
      j.appendChild(g),
      h.appendChild(j),
    ...
    a &&
      (m_helper.each(
        ...
        function(d) {
          d.dataset.val == a &&
            (b && !d.checked
              ? (m_helper.check(d), c._onCheckBoxChange(d, c))
              : !b &&
                d.checked &&
                (m_helper.uncheck(d), c._onCheckBoxChange(d, c)));
        }
      ),
      c._updateText(c));
  },
  ...
  _appendEvents: function() {
    ...
    document
      ...
      .addEventListener("focus", function(c) {
        a._showList(a),
          (document.getElementById(a._getInputFieldIdentifier()).value = ""),
          m_helper.each(window.multiselects, function(d) {
            document.getElementById(d._getItemListIdentifier()).offsetParent &&
              m_helper.parent(c.target, d._getIdentifier()) &&
              d._hideList(a);
          });
      }),
      document
      ...
      document
        .getElementById(a._getIdentifier())
      ...
      document
        .getElementById(a._getItemListIdentifier())
    ...
    var b = function() {
      ...
      if (!c || "" == c)
        m_helper.show(
          document.querySelector("#" + a._getItemListIdentifier() + " > span")
        ),
          m_helper.show(
            document.querySelector("#" + a._getItemListIdentifier() + " > hr")
          ),
          m_helper.showAll(
            document.querySelectorAll("#" + a._getItemListIdentifier() + " li")
          );
      else {
        m_helper.hide(
          document.querySelector("#" + a._getItemListIdentifier() + " > span")
        ...
        var d = Array.prototype.filter.call(
          document.querySelectorAll(
            "#" + a._getItemListIdentifier() + " li span"
          ),
          function(f) {
    ...
    document
      .getElementById(a._getInputFieldIdentifier())
      .addEventListener("propertychange", b),
      document
        .getElementById(a._getInputFieldIdentifier())
        .addEventListener("input", b);
  },
  _onCheckBoxChange: function(a, b) {
    a.dataset.multiselectElement
      ? (b._performSelectItem(a, b), b._updateSelectAll(b))
      : b._performSelectAll(a, b),
      b._forceUpdate();
  },
  _performSelectItem: function(a, b) {
    ...
    a.checked
      ? (b._itemCounter++,
        ...
        m_helper.setActive(a.parentElement.parentElement))
      : (b._itemCounter--,
  ...
  _performSelectAll: function(a, b) {
    ...
    a.checked
      ...
      : ((b._itemCounter = 0),
        m_helper.each(c, function(d) {
          d.multiselectElement.parentElement.parentElement.classList.remove(
            "active"
          ),
  ...
  _updateSelectAll: function(a) {
    ...
    a._itemCounter == a._getItems().length
      ? (b.checked = !0)
  ...
  _hideList: function(a, b) {
    m_helper.setUnactive(document.getElementById(a._getItemListIdentifier())),
      ...
      m_helper.show(
        document.getElementById(a._getItemListIdentifier()).querySelector("hr")
      ),
      m_helper.showAll(
        document
          .getElementById(a._getItemListIdentifier())
  ...
  _updateText: function(a) {
    ...
    if (0 < b.length) {
      ...
      (c = c.substr(0, c.length - 2)),
        20 < c.length && (c = c.substr(0, 17) + "...");
    }
    b.length ==
      document
        .getElementById(a._getItemListIdentifier())
        .querySelectorAll("ul li").length && (c = "All selected"),
  ...
  _forceUpdate: function() {
    ...
    if (((a.style.visibility = "hidden"), 0 != this._itemCounter)) {
      ...
      10 > this._itemCounter
        ? ((a.style.left = "-45px"), (b.style.marginLeft = "-42px"))
        : 100 > this._itemCounter
        ? ((a.style.left = "-50px"), (b.style.marginLeft = "-47px"))
        : 1e3 > this._itemCounter
        ? ((a.style.left = "-55px"), (b.style.marginLeft = "-52px"))
        : 1e4 > this._itemCounter &&
          ((a.style.left = "-60px"), (b.style.marginLeft = "-57px"));
    }
  },
  _items: void 0,
  _itemCounter: 0,
  ...
  "undefined" == typeof $
    ? ((document.multiselect = function(a) {
        var b = [];
        return (
          window.multiselects._items || (window.multiselects._items = []),
...
function hideMultiselects(a) {
  m_helper.each(window.multiselects, function(b) {
    document.getElementById(b._getItemListIdentifier()).offsetParent &&
      !m_helper.parent(a.target, b._getIdentifier()) &&
      b._hideList(b, a);
  });
}

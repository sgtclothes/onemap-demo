function ServiceLayerDemographic(GIS, map, config) {
  ...
  function renderDemographic(idform) {
  ...
  function setStyleLegendClass() {
    setTimeout(function() {
      ...
      legendClass.setAttribute(
        "style",
        "background: rgba(255,255,255,0.7); height:300px; overflow-y:hidden"
      );
  ...
  function getAllDemographic(id, form) {
    document.getElementById(id).addEventListener("change", function() {
      if (this.checked) {
        ...
        let layerArr = renderDemographic(idform);
  ...
  function getPerDemographic(id, form) {
    document.getElementById(id).addEventListener("change", function() {
      if (this.checked) {
        let idform = document.getElementById(form);
        let layerArr = renderDemographic(idform);
  ...
  getAllDemographic("tall-3", "all-demographic");
  getPerDemographic("tall-3-1", "all-demographic");
  // getPerDemographic("tall-3-2", "all-demographic");
  // getPerDemographic("tall-3-3", "all-demographic");

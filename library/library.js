...
function load(
  ...
  window.ESRI = {};
  window.ESRI.Basemap = Basemap;
  window.ESRI.PortalItem = PortalItem
  ...
  window.ESRI.WebTileLayer = WebTileLayer;
  ...
  window.ESRI.LocalBasemapsSource = LocalBasemapsSource
  ...
  if (typeof dashboardBoot === 'function') {
    dashboardBoot(GIS)
  }
}

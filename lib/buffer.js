...
export class Pointing {
  ...
  render() {
    ...
    var url = "http://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/reverseGeocode?f=pjson&featureTypes=&location=" + this.Longitude + "," + this.Latitude;
    ...
    EsriRequest(url, {
      responseType: "json"
        ...
        // The requested data
        let popupContent = {
          title: response.data.address.Subregion+", "+response.data.address.Region,

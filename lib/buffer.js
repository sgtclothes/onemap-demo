...
export class Viewer {
  ...
  addTreeview(storage, nameFile, length, createdBy) {
    ...
    if (localStorage.getItem("createdBy-" + storage) !== null) {
      if (JSON.parse(localStorage.getItem("createdBy-" + storage)).includes(createdBy)) {
        setTimeout(function() {
    ...
    function createTreeview(storage) {
      $.get("template/treeview.php", function(data) {
        ...
        $.get("template/addPOI.php", function(poi) {
          ...
          $(".user-poi-" + storage + "-" + createdBy).append(poi);
    ...
    function createSubPOI(storage) {
      $.get("template/addPOI.php", function(poi) {
        console.log($(".user-poi-" + storage + "-" + createdBy));
        $(".user-poi-" + storage + "-" + createdBy).append(poi);
        $(".user-poi-" + storage + "-" + createdBy + " .li-user-poi").attr(
          "class",
          "li-user-poi-" + storage + "-" + createdBy + "-" + length

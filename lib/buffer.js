...
export class ConvertCSV {
    ...
    csvStore.fetch({
      onComplete: function(items) {
        ...
        arrayUtils.forEach(items, function(item) {
          ...
          // self.renderPOI(self.PointColor, longitude, latitude, attributesVal, infoTemplate)
          // self.Longitude = longitude
          // self.Latitude = latitude
          // self.AttributesVal = attributesVal
  ...
  // renderPOI(pointColor, longitude, latitude, attributesVal, infoTemplate) {
  //   let mapView = this.MapView;
  //   let point = new ESRI.Point({
  //     longitude: longitude,
  //     latitude: latitude

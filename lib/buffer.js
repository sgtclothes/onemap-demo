export class Radius {
  constructor(map, mapView, latitude, longitude) {
    ...
    this.FeatureLayer = new ESRI.FeatureLayer(
      "https://gis.locatorlogic.com/arcgis/rest/services/BPS/BPS_ONLY_2016/MapServer/532"
    );
  }
  ...
  create() {
    ...
    this.FeatureLayer.queryFeatures(query).then(function(results) {
      ...
      arrayUtils.forEach(results.features[0].layer.defaultPopupTemplate.fieldInfos, function(field) {

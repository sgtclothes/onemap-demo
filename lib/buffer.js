...
export class Viewer {
  ...
  filterData() {
    ...
    function getFilteredData(i, j) {
      ...
      convertData.insert("dataFilter", self.Method.TempData);
    ...
    function createFilteredViewer() {
      ...
      if ($(".filter-master").length < 1) {
        ...
        labelMasterCheckBox.innerHTML = " Filtered_Data";
      ...
      $(document).delegate("input:checkbox", "click", function() {
        if ($(this).prop("checked") == true) {
          ...
          if ($(this).siblings("a").length < 1) {
            ...
            } else if ($(this).siblings("ul[id='filtered-data']").length > 0) {
              alert("OK");
            } else {
              $(this)
                .siblings("ul")

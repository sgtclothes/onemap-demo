...
export class BatasAdministrasi {
  ...
  summaryAnalysis(){
    ...
    this.female = female
    this.ses_up = ses_up
    this.ses_mid = ses_mid
    this.ses_low = ses_low
    this.food_1 = food_1
    this.food_2 = food_2
    this.food_3 = food_3
    this.food_4 = food_4
    this.food_5 = food_5
    this.jml_bangun = jml_bangun
    this.nfood_1 = nfood_1
    this.nfood_2 = nfood_2
    this.nfood_3 = nfood_3
    this.nfood_4 = nfood_4
    this.nfood_5 = nfood_5
    this.expend_1 = expend_1
    this.expend_2 = expend_2
    this.expend_3 = expend_3
    this.expend_4 = expend_4
    this.expend_5 = expend_5
    this.sesa = sesa
    this.sesb = sesb
    this.sesc = sesc
    this.sesd = sesd
...
export class BatasAdministrasiDriving {
  ...
  render() {
    ...
    query.outFields = ["provinsi","kab_kota","kecamatan","desa","kepadatan","populasi","jml_kk","populasi","pop_lk","pop_pr","ses_up","ses_mid","ses_low","food_1","food_2","food_3","food_4","food_5","jml_bangun","nfood_1","nfood_2","nfood_3","nfood_4","nfood_5","expend_1","expend_2","expend_3","expend_4","expend_5","u00_04","u05_09","u10_14","u15_19","u20_24","u25_29","u30_34","u35_39","u40_44","u45_49","u50_54","u55_59","u60_64","u65_69","u70_74","u75_79","u80_84","u85_89","u90_94","u95up","ses_a","ses_b","ses_c","ses_d","ses_e"];
    query.returnGeometry = true;
    this.FeatureLayer.queryFeatures(query).then(function(results) {
